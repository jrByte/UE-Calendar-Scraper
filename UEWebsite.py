...
class main:
    ...
    def loginWebsite(self):
        ...
        with requests.Session() as request:
            ...
            # The website operates by keeping your session token in the url itself. This is insecure, but is the only way for me to access data for now.
            ...
            # The for loop is iterating through months 10-12, this was just for the current semester. Classes aren't posted any later than this range.
